...
def imshow_det_bboxes(img,
    ...
    bbox_color1 = color_val_matplotlib('purple')
    bbox_color2 = color_val_matplotlib('blue')
    bbox_color3 = color_val_matplotlib('yellow')
    bbox_color4 = color_val_matplotlib('orange')
    ...
    for i, (bbox, label) in enumerate(zip(bboxes, labels)):
        ...
        if 'working_condensing_tower' in label_text:
        ...
        if 'unworking_condensing_tower' in label_text:
            poly = [[bbox_int[0], bbox_int[1]], [bbox_int[0], bbox_int[3]],
                [bbox_int[2], bbox_int[3]], [bbox_int[2], bbox_int[1]]]
            np_poly = np.array(poly).reshape((4, 2))
        ...
        #    horizontalalignment='left')
        #'''
        if 'working_chimney' in label_text:
            poly = [[bbox_int[0], bbox_int[1]], [bbox_int[0], bbox_int[3]],
                [bbox_int[2], bbox_int[3]], [bbox_int[2], bbox_int[1]]]
            np_poly = np.array(poly).reshape((4, 2))
        ...
        #    horizontalalignment='left')    
        #'''
        if 'unworking_chimney' in label_text:
            poly = [[bbox_int[0], bbox_int[1]], [bbox_int[0], bbox_int[3]],
                [bbox_int[2], bbox_int[3]], [bbox_int[2], bbox_int[1]]]
            np_poly = np.array(poly).reshape((4, 2))
